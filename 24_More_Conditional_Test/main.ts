import { Console } from "console";
         ...
         // unequiality
          console.log("Unequiality Test with srtings : " ,  ("Man" as string) != "Women");
         // lower case function
         console.log("Lower Case Function Test: ", "HELLO".toLowerCase() === "hello");
         //• Numerical tests involving equality
         console.log("Equiality Test with Number : " ,  60 === 60);
        //• Numerical tests involving unequality
        console.log("Unequiality Test with number : " ,  (60 as number) != 70);
         //greater than test
        ...
        const vegitable: string[] = [`Tommato`,`Potato`,`Carrot`,`Brinjal`,`Couliflower`];
